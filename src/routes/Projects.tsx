    ...
    return (
        <div className="w-screen h-screen px-[8%] pt-[4%]">
            ...
            <div className="w-[84%] md:w-full">
                <p className="text-3xl md:text-4xl lg:text-5xl xl:text-7xl font-medium text-center">My Work 🌲</p>
                <p className="text-lg md:text-xl lg:text-2xl xl:text-3xl font-medium text-gray-500 text-center mt-3">Projects and Academic Achievements</p>
            </div>
            ...
            <div className="mt-[8%] md:mt-[3%] w-[84.5%] md:w-full flex flex-col md:flex-row gap-x-[15%]">
                <div className="flex flex-col gap-y-6 md:max-w-[45%]">
                    <p className="text-2xl md:text-3xl lg:text-4xl font-bold">Finished 📦</p>
                    ...
                    <div className="flex flex-col md:flex-row md:flex-wrap gap-x-3 gap-y-3">
                        ...
                        <button className="w-full min-h-72 h-[55%] md:w-64 md:h-64 bg-yellow-400 border-gray-300 shadow-md rounded-xl flex flex-col gap-y-1 items-center justify-center hover:opacity-60"
                            onClick={() => window.open('https://github.com/AdrianEnev/next-todo.git')}
                        >
                            <p className="text-4xl font-semibold text-white">Next</p>
                            <p className="text-4xl font-semibold text-white">Todo</p>
                        </button>
                    </div>
                </div>
                ...
                <div className="w-full h-full mt-[8%] md:mt-0 mb-[15%] md:mb-0">
                    <div className="flex flex-col gap-y-6">
                        <p className="text-2xl md:text-3xl lg:text-4xl font-bold">In Progress ⏳</p>
