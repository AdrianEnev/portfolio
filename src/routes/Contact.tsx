    ...
    return (
        <div className="w-screen h-screen px-[8%] pt-[4%]">
            ...
            <div className="w-[84%] md:w-full">
                <p className="text-3xl md:text-4xl lg:text-5xl xl:text-7xl font-medium text-center">Contact Me</p>
                <p className="text-lg md:text-xl lg:text-2xl xl:text-3xl font-medium text-gray-500 text-center mt-3">Find my Links Below 🔗</p>
            </div>
            ...
            <div className="mt-[8%] md:mt-[5%] w-[80%] md:w-full flex flex-col md:flex-row gap-x-[10%]">
                <div className="flex flex-col gap-y-6 md:max-w-[45%]">
                    ...
                    <p className="sm:text-sm md:text-base lg:text-lg xl:text-xl">
                        🔍 Curious about my work? Feel free to check out my GitHub or explore the <span onClick={() => {setLocation('/projects')}} className="font-bold text-blue-500 hover:opacity-60">Projects</span> section of this website.
                    </p>
